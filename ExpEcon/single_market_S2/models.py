    ...
    def live_auction(self, data):
        ...
        if type == 'sell':
            ...
            if self.num_of_trading == 2:
                ...
                if price < self.seller_first_lowest_price + 40:
                ...
                if price < self.seller_second_lowest_price + 40:
                    response = dict(type='lower_price')
            ...
            if self.num_of_trading == 2:
                ...
                if price > self.buyer_first_highest_price:
                ...
                if price > self.buyer_second_highest_price:
                    response = dict(type='higher_price')
                    return {seller: response}
                else:
                    response = dict(
            ...
            if self.num_of_trading >= 2: #買い手の取引が2回行われていた時
                ...
                print('kiteruttay')
                if self.buyer_first_highest_price < price: #買い手の許容価格より価格が高い時
                    response = dict(type='higher_price')
                    ...
                    group.get_player_by_id(buyer).payoff_1 = group.get_player_by_id(buyer).buyer_first_highest_price - price
                    ...
                    if group.get_player_by_id(seller).num_of_trading == 0: #売り手の取引回数が一回目の時
                        ...
                        group.get_player_by_id(seller).payoff_1 = price - 40 - group.get_player_by_id(seller).seller_first_lowest_price
                        ...
                        group.get_player_by_id(seller).payoff_2 = price - 40 - group.get_player_by_id(seller).seller_second_lowest_price
                ...
                if self.buyer_second_highest_price < price: #買い手の許容価格より価格が高い時
                    response = dict(type='higher_price')
                    return {buyer: response}
                else: #取引成立
                    group.hist_traded_price += str(price) + ','
                    ...
                    group.get_player_by_id(buyer).payoff_2 = group.get_player_by_id(buyer).buyer_second_highest_price - price
                    group.hist_buyer += str(buyer) + ','
            ...
            if self.num_of_trading >= 2: #売り手の取引が2回行われていた時
                ...
                if self.seller_first_lowest_price + 40 > price: #売り手の許容価格より価格が低い時
                    response = dict(type='lower_price')
                    return {seller: response}
                else:
                    group.hist_traded_price += str(price) + ','
                ...
                if self.seller_second_lowest_price + 40 > price: #売り手の許容価格より価格が低い時
                    response = dict(type='lower_price')
                    return {seller: response}
                else:
                    group.hist_traded_price += str(price) + ','
